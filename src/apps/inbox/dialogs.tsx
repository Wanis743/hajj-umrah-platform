/**
 * Inbox — the three dialogs.
 *
 * None of them is a confirmation. Approve and Certify act on the first press,
 * because a queue whose every act asks "are you sure?" is a queue people stop
 * reading. What is here exists for a reason the server gives:
 *
