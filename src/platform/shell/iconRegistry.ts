 ...
 * lives in the SDK (`ui/glyphs`), because the Store resolves exactly the same
 * names and cannot import the shell; this module re-exports it under the name
 * the shell has always used, and adds the file-type lookup, which is shell and
 * Explorer business only.
 *
...
/** File-type glyphs used by Explorer, the desktop and Open/Save dialogs. */
