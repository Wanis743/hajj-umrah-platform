...
// None of the three large workspaces that used to be tabs here is one any more. The CRM,
// the document library and the BI studio are OS apps (`src/apps/crm`, `src/apps/dms`,
// `src/apps/bi`), launched from Start like every other app, and this dashboard has no tab
// for any of them.
