    ...
    <div className="p-6 space-y-6 text-slate-200">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">Monitor SOX compliance, exceptions, and month-end close status</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="p-4 bg-slate-900/50 border border-white/5 rounded-xl">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="font-medium text-slate-300">Open Exceptions</h3>
          </div>
        ...
        <div className="p-4 bg-slate-900/50 border border-white/5 rounded-xl">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="font-medium text-slate-300">Controls Tested</h3>
          </div>
        ...
        <div className="p-4 bg-slate-900/50 border border-white/5 rounded-xl">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="font-medium text-slate-300">Close Readiness</h3>
          </div>
      ...
      <div className="bg-slate-900/40 border border-white/10 rounded-xl overflow-hidden">
        <div className="p-4 border-b border-white/10 flex justify-between items-center bg-slate-800/30">
          <h3 className="font-medium text-slate-200">Exception Management</h3>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <span className="font-medium text-slate-200">{exc.code}</span>
                    <span className="text-xs px-2 py-0.5 rounded-full bg-slate-800 text-slate-400">
                      {exc.status}
                    </span>
                  </div>
                  <p className="text-sm text-slate-400 mt-1">{exc.description}</p>
                </div>
              </div>
