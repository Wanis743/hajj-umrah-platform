  ...
  return (
    <div className="flex flex-col h-full bg-slate-950 text-slate-200">
      <div className="flex items-center justify-between p-6 border-b border-white/10">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-slate-200">Lead Desk</h1>
          <p className="text-sm text-slate-400 mt-1">Manage and track inbound leads</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input 
              ...
              className="pl-9 pr-4 py-2 bg-slate-900/50 border border-white/10 rounded-lg text-sm focus:outline-none focus:border-indigo-500/50 transition-colors w-64"
            />
          </div>
          <button className="flex items-center gap-2 px-3 py-2 text-sm font-medium bg-slate-900/50 border border-white/10 rounded-lg hover:bg-slate-800/50 transition-colors">
          ...
          <div className="grid grid-cols-1 gap-4">
            {filteredLeads.map((lead, i) => (
              <motion.div 
                ...
                className="flex items-center justify-between p-4 bg-slate-900/40 backdrop-blur-md border border-white/10 rounded-xl hover:bg-slate-800/50 transition-colors cursor-pointer"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-base font-medium text-slate-200">{lead.name || 'Unnamed Lead'}</h3>
