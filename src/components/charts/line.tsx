...
function LineSeriesStroke({
  ...
  // NOTE(bklit-vendoring): upstream types this `RefObject<SVGPathElement | null>`
  // (React 19 ref model). We run @types/react 18 — `Ref<SVGPathElement>` wants
  // `RefObject<SVGPathElement>` here, produced by `useRef<SVGPathElement>(null)`.
