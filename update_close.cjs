...
const file = path.join(process.cwd(), 'src', 'components', 'admin', 'FinanceOS', 'CloseCenter.tsx');
      ...
      <div className="p-6 border-b border-slate-700/50 flex justify-between items-center bg-slate-900/50">
        <div>
          <h2 className="text-2xl font-light text-white flex items-center gap-3">
            ...
            {t('OOU,O U, O U,U?OOOc', 'ClA'ture Mensuelle', 'Period Close Center')}
          </h2>
        ...
        <div className="flex gap-3">
          ...
          >
            ...
            {t('OOU,O U,', 'ClA'turer', 'Lock Period')}
          </button>
        </div>
      </div>
...
console.log('Updated CloseCenter.tsx');
